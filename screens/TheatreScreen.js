...
const TheatreScreen = () => {
    ...
    const showSeats = () => {
        return (
               <View style={{flexDirection:"row",alignItems:"center"}}>
                ...
                <Text style={{ marginTop: 4, fontSize: 17,paddingHorizontal:4}}>{seat}
                </Text>
                ))}
                </View>
    )
    ...
    return (
        <SafeAreaView>
            ...
            <Text style={{ textAlign: "center", fontSize: 13, fontWeight: "bold", marginTop: 10, color: "gray" }}>CLASSIC (240)</Text>
            ...
            <View style={{flexDirection:"row",alignItems:"center",marginTop:20,backgroundColor:"#DBDBDB",padding:10,paddingLeft:100}}>
                <View>
                    <FontAwesome style={{textAlign:"center",marginBottom:4}} name="square" size={24} color="#ffc40c" />
                    <Text>Selected</Text>
                </View>
                <View style={{marginHorizontal:20,}}>
                    <FontAwesome  style={{textAlign:"center",marginBottom:4}}  name="square" size={24} color="white" />
                    <Text>Vacant</Text>
                </View>
                <View>
                    <FontAwesome  style={{textAlign:"center",marginBottom:4}}  name="square" size={24} color="#989898" />
                    <Text>Occupied</Text>
                </View>
            ...
            <View style={{flexDirection:"row",alignItems:"center" ,justifyContent:"space-between",marginTop:14,}}>
                <View style={{padding:10,}}>
                    <Text style={{ marginBottom: 4, fontSize: 15, fontWeight: "500" }}>show end time approx 6.51pm</Text>
                    {seats.length > 0 ? (
                    showSeats()
                    ) : (
                ...
                <View style={{backgroundColor:"#E0E0E0",padding:10,bordeTopLeftRadius:6,borderBottomLeftRadius:6,marginTop:10,}}>
                    <Text style={{width:120,}}>Now with ticket cancellation</Text>
                </View>
            </View>
            <Pressable style={{ backgroundColor: "#ffc40c", padding: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginVertical: 20, }}>
                {seats.length > 0 ? (
